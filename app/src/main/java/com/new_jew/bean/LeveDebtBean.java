 ...
 */
public class LeveDebtBean extends BaseAdapter{
    private ArrayList<ScreenBean> mlist;
    private boolean ischeck=false;
    private int clickStatus=-1;

    public LeveDebtBean(ArrayList<ScreenBean> mlist, Context context) {
        this.mlist = mlist;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView=inflater.inflate(R.layout.layout_debt_level_item,null);
            hodler.mtext= (TextView) convertView.findViewById(R.id.text_level);
