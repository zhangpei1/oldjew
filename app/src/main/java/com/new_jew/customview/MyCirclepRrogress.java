...
/**
 * Created by zhangpei on 2016/11/29.
 */
public class MyCirclepRrogress extends View {
    /**
     *  外圆环的颜色
     */
    ...
    public void setDown_text(String down_text) {
        this.down_text = down_text;
        postInvalidate();
    }
    ...
    public MyCirclepRrogress(Context context, AttributeSet attrs) {
    ...
    public MyCirclepRrogress(Context context) {
        super(context);
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                for (int i = 0; i <= percent; i++) {
                    ...
                    progress = i;
                    MyCirclepRrogress.this.postInvalidate();
                }
            }
